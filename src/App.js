		...
		<div className="App">
			...
			<div className='appContainer'>
				<div className='text'>
					...
					<a href='https://github.com/OkashaTanoli/Tiny-Animation' style={{ textDecoration: 'none' }} target='_blank'><button ref={ref} className='githubBtn'>View On Github<img src={Github} style={{ marginLeft: '10px' }} width='50px' /></button></a>
				</div>
				<div>
					<Illustration />
				</div>
